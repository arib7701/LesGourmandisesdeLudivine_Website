...
(function(window) {
  ...
  function Photostack(el, options) {
    ...
    this.allItemsCount = this.inner.children.length;
  ...
  Photostack.prototype._addNavigation = function() {
    ...
    classie.addClass(this.nav, 'navPhoto');
    var inner = '';
    for (var i = this.itemsCount - 10; i < this.itemsCount; ++i) {
      inner += '<span></span>';
    }
  ...
  Photostack.prototype._shuffle = function(resize) {
    ...
    var overlapFactor = 0.5,
      ...
      columns = Math.ceil(
        this.sizes.inner.height / (this.sizes.item.height * overlapFactor)
      ),
        ...
        self.allItems.forEach(function(item, i) {
          ...
          if (
            ...
            item.style.WebkitTransform =
              ...
              translation.y +
              'px) rotate(' +
              Math.floor(Math.random() * (maxrot - minrot + 1) + minrot) +
              'deg)';
    ...
    if (
      ...
      var left = Math.random() < 0.5,
        ...
        noOverlapX = left
          ...
          : areaVal.x + dxArea - (itemVal.x + dxItem) + dxItem + randExtraX,
        noOverlapY = left
          ? (itemVal.y - areaVal.y + dyItem) * -1 - randExtraY
          : areaVal.y + dyArea - (itemVal.y + dyItem) + dyItem + randExtraY;
